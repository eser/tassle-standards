...
-   The class is a static class. See [Static Class Design](../type/static-class.md).  
...
-   The class is an attribute that requires very fast runtime look-up. Sealed attributes have slightly higher performance levels than unsealed ones. See [Attributes](../usage/attributes.md).  
